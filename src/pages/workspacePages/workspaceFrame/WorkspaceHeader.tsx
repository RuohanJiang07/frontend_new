...
export default function WorkspaceHeader() {
    ...
    const trackOffset = tabScroll * TAB_WIDTH;
    // 当前可见tab
    ...
    return (
        <div className="w-full flex items-center px-6 py-2   shadow-sm">
            {/* 返回+课程名 */}
            ...
            <div className=" flex-1">
                ...
                >
                    ...
                    <div className='flex items-center justify-between bg-[#ECECEC] rounded-[20px] px-2 py-2 w-[550px]'>
                        {/* tab列表（只显示visibleTabs） */}
                        <div style={{ width: TAB_WIDTH * VISIBLE_COUNT, overflowX: 'auto' }}>
                            <div className='flex items-center  gap-2 transition-transform duration-50'
                            >
                                {visibleTabs.map((tab, idx) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`relative flex items-center justify-between mx-1 px-3 py-1  rounded-full cursor-pointer transition
                                ${activePage === realIdx
            ...
            <div className="flex items-center ml-6 gap-3">
                <div className="relative">
                    <input
                        className="h-8 w-56 rounded bg-[#f7f6f6] px-3 pl-9 text-sm border border-[#e0e0e0]"
