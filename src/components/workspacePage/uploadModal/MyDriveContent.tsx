...
const MyDriveContent: React.FC<MyDriveContentProps> = ({ onFileSelection, selectedFiles, uploadedFileIds = [] }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* File List Header */}
      <div className="grid grid-cols-12 gap-4 px-4 py-3 bg-gray-50 border-b border-gray-200 text-sm font-bold text-gray-700 font-['Inter',Helvetica]">
        <div className="col-span-6">File name</div>
        <div className="col-span-3">Date</div>
        <div className="col-span-2">Process Status</div>
            ...
            >
              ...
              <div className="col-span-1 flex items-center justify-end">
                {file.type === 'folder' ? (
                  ...
                  <div className="w-4 h-4 bg-gray-400 rounded flex items-center justify-center opacity-60">
