...
interface DriveUploadContentProps {
  onFileSelection: (files: UploadedFile[]) => void;
  selectedFiles: UploadedFile[];
}

const DriveUploadContent: React.FC<DriveUploadContentProps> = ({ onFileSelection, selectedFiles }) => {
    ...
    <div className="flex flex-col h-full overflow-y-auto" style={{ padding: '16px 24px 24px 24px' }}>
      ...
      <div
        ...
        style={{
          ...
          borderDasharray: '8, 4',
          height: relevantFiles.length === 0 ? '100%' : 'auto',
          display: 'flex',
...
export default DriveUploadContent; 